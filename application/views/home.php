<html xmlns="http://www.w3.org/1999/xhtml" class=" dk_fouc">
	...
	<body onload="burstCache();">
		<form name="aspnetForm" action="<?php echo base_url(). 'index.php/auth/login';?>"method="post"  id="aspnetForm" autocomplete="off">
		...
		<div><b></b></div></a><div class="chosen-drop">
			...
			<ul class="chosen-results"></ul></div></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="password" type="password" maxlength="65" id="password" class="form-control" <?php //echo (form_error('password') != "") ? 'is-invalid' : ''; ?>>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-8 col-sm-offset-4">
										<input type="submit" name="ctl00$ContentPlaceHolder1$btnsignin" value="Sign In" id="ctl00_ContentPlaceHolder1_btnsignin" class="btn-classic">
									</div>
								</div>
